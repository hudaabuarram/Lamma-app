...
import 'package:lamma/Screens/LikesScreen.dart';
import 'package:lamma/Screens/commentScreen.dart';
import 'package:lamma/Screens/friendsProfileScreen.dart';
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: suffix != null
              ? IconButton(
                  ...
                  icon: Icon(suffix, color: Colors.teal))
              : null,
        ),
      ),
    );
  ...
  double? width = 400,
    ...
    Container(
      ...
      child: MaterialButton(
        color: Colors.teal,
        shape: OutlineInputBorder(borderRadius: BorderRadius.circular(30),borderSide: BorderSide(color: SocialCubit.get(context).borderColor)),
        onPressed: onTap,
        child: Text(
          '$text',
          style: TextStyle(
